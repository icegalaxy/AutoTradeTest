...
public class RuleBouncing3 extends Rules {
	...
	public RuleBouncing3(WaitAndNotify wan1, WaitAndNotify wan2,
	...
	public void openContract() {
		...
		if (getTimeBase().getRSI() < 20)
			shutDownLong = true;
		
		if (getTimeBase().getRSI() > 80)
			shutDownShort = true;
		...
		if (getTimeBase().getRSI() < 40 && shutDownShort)
			longContract();
		
		else if (getTimeBase().getRSI() > 60 && shutDownLong)
			shortContract();
