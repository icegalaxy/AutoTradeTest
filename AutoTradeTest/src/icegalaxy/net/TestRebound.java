...
public class TestRebound extends Rules
{



	public TestRebound(WaitAndNotify wan1, WaitAndNotify wan2, boolean globalRunRule)
	{
	...
	public void openContract()
	{
		...
		OHLC[] ohlcs = new OHLC[]{GetData.open, GetData.pHigh, GetData.pLow, GetData.pClose};
		...
		if (Global.getCurrentPoint() < ohlc.position + 5
		...
		}else if (Global.getCurrentPoint() > ohlc.position -5
				&& GetData.getEma5().getEMA() < ohlc.position)
		{
