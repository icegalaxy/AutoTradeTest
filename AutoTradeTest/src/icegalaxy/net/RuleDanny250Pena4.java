...
//					return;
			...
			if (Global.getCurrentPoint() < GetData.getEma1200().getEMA()
					&& GetData.getEma1200().getEMA() - Global.getCurrentPoint() < 30)
			{
				Global.addLog("Too close to EMA1200");
				return;
			}
...
//					return;
			...
			if (Global.getCurrentPoint() > GetData.getEma1200().getEMA()
					&& Global.getCurrentPoint() - GetData.getEma1200().getEMA() < 30)
			{
				Global.addLog("Too close to EMA1200");
				return;
			}
