...
public class RuleEMA extends Rules {
	...
	public void openContract() {
		...
		if (getTimeBase().getEMA(10) < getTimeBase().getEMA(20)) {
			...
			while (getTimeBase().getEMA(10) - bufferPt < getTimeBase().getEMA(20) // �來�I�����
					&& Global.isOrderTime() && getTimeBase().getRSI() < 70 // �O�y�[���Y���P���A�[�����Rd
			) {
...
//					|| getTimeBase().getFluctuation() < fluctuation
					|| getTimeBase().getHL(60).getRsiFluctuation() > rsiFluctuation //rsi Flu�V�j��ܤW�U�i��j,�V�ӧY�V���䨫
